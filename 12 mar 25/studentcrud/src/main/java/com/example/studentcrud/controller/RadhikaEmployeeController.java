...
import com.example.studentcrud.service.RadhikaEmployeeService;
import org.springframework.ui.Model;

@Controller
@RequestMapping("/radhika")
public class RadhikaEmployeeController {

    @Autowired
    private RadhikaEmployeeService employeeService;
